...
public class UITextRectangle extends UIObject {
	...
	public void render(Graphics g) {
		...
		for(Text t : texts){
			...
			g.setFont(newFont);
			if(centerText){
				g.drawString(t.getString(), (int) bounds.x+t.getX()-g.getFontMetrics().stringWidth(t.getString())/2, (int) (bounds.y+t.getY()+t.getSize()/4));
			}else{
				g.drawString(t.getString(), (int) bounds.x+t.getX(), (int) (bounds.y+t.getY()+t.getSize()/4));
