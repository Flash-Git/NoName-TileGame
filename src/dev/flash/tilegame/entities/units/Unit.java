...
public abstract class Unit extends Entity{
	...
	protected void updateVariables(){
		...
		setLifeTime((int)(scalingLifeTime*(level-1)+baseLifeTime));
		setDeathTime((int)(scalingDeathTime*(level-1)+baseDeathTime));
		setIdleTime((int)(scalingIdleTime*(level-1)+baseIdleTime));
	}
...
//		}
	...
	public void attackCoords(int tX, int tY){
		...
		int targetX = (int) applyAccuracy(distanceToTarget, getCenterX(), tX);
		int targetY = (int) applyAccuracy(distanceToTarget, getCenterY(), tY);
